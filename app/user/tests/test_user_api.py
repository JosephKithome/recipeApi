...
CREATE_USER_URL = reverse('user:create') # app_name user
...
class PublicUserApiTests(TestCase):
    ...
    def test_create_valid_user_success(self):
        ...
        payload = {
            'email': 'test@devsoftdevelopers.com',
            'password': 'testPASS',
            'name': 'testName'
        }
    ...
    def test_password_too_short(self):
        """Test the password is more than 8 charcters"""
    ...
    def test_create_token_invalid_credentials(self):
        ...
        create_user(email='test@softdev.com', password='goodpass')
        payload = {'email': 'test@softdev.com', 'password': 'wrong'}
    ...
    def create_token_no_user(self):
        ...
        payload = {'email': 'test@softdev.com', 'password':'goodpass'}
        res = self.client.post(TOKEN_URL, payload)
        self.assertNotIn('token',res.data)
        self.assertEqual(res.status_code, status.HTTP_400_BAD_REQUEST)
    ...
    def test_create_token_missing_field(self):
        ...
        res = self.client.post(TOKEN_URL, {'email': 'test@softdev.com', 'password': ''})
    ...
    def test_retrieve_user_unauthorised(self):
        """Test that authentication fails is required for users"""
